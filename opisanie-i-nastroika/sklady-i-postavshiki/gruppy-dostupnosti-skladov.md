...
{% hint style="warning" %}
Если в группу необходимо добавить все склады поставщика - достаточно указать Поставщика, при обновлении групп доступности записи в регистре добавятся по всем складам поставщика с указанным типом остатков
{% endhint %}
...
Порядок складов влияет на позицию товарно предложения в выдаче. Чем выше приоритет склада, тем выше товар в списке.
