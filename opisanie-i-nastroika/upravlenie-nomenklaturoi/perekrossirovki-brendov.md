...
{% hint style="info" %}
При установленном флаге "Автоотбор" при выборе любого бренда в списке необработанных брендов будет автоматически происходить поиск по первым трём символам в списке основных брендов.
{% endhint %}
...
![](../../.gitbook/assets/image%20%28487%29%20%281%29.png)
